...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    _G.FastAttackTeus_Mode = Value
	if _G.FastAttackTeus_Mode == "Fast Attack" then
		_G.Fast_Delay = 0.1
	elseif _G.FastAttackTeus_Mode == "Normal Attack" then
		_G.Fast_Delay = 0.15
	elseif _G.FastAttackTeus_Mode == "Super Fast Attack" then
		_G.Fast_Delay = 0
	end
end)
...
while wait() do
    pcall(function()
        if _G.FastAttackTeus then
            repeat wait(_G.DelayAttackPlayer)
               AttackNoCoolDown()
            until not _G.FastAttackTeus
        end
    end)
end
end)
